...
#addpic_button = tk.Button(root, bg="#ffcccc", cursor="heart", font=("Times", 10), fg="#000000", justify="center", text="PICTURE", relief="groove", borderwidth="3px", command=add_image)$
